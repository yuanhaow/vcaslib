...
import algorithms.kiwi.util.CombinedGenerator;
import algorithms.kiwi.util.IntegerGenerator;
import algorithms.kiwi.util.Pair;
import algorithms.kiwi.util.ZipfianGenerator;
...
public class Parameters {
	...
	public static double rebalanceProbPerc = 2; // 15 in paper
	public static double sortedRebalanceRatio = 1.8; // 1.6 in paper
