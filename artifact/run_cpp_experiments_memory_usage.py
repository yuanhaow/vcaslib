...
if len(sys.argv) == 1 or sys.argv[1] == '-h':
  print("Usage: python3 run_cpp_experiments_memory_usage.py [num_keys] [update_threads] [rq_threads] [rqsizelist] [outputfile] [num_repeats] [runtime]")
  print("For example: python3 run_cpp_experiments_memory_usage.py 10000 4 4 [8,256] graph.png 1 1")
  exit(0)
...
graph.plot_cpp_memory_usage_graphs(results_file_name, graphfile, graphtitle)
